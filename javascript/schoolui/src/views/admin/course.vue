  ...
  <div>
    ...
    <el-card>
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="4">
          <el-button type="primary" @click="addcoursedialog">添加课程</el-button>
        </el-col>
      </el-row>
      <!-- 课程列表 -->
      <el-table :data="courselist" border>
        ...
        <el-table-column prop="cteacher" label="教师" width="180"></el-table-column>
    ...
    <!-- 添加对话框 -->
    <el-dialog title="添加课程" v-model="adddialogVisible" width="50%">
      <!--内容主体  -->
    ...
    <!-- 编辑对话框 -->
    <el-dialog title="修改课程" v-model="editdialogVisible" width="50%">
      <!--内容主体  -->
      <el-form label-position="left" label-width="80px">
        <el-form-item label="课程名称">
